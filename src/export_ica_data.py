...
# 加载PCA数据
pca_file = 'data/processed/fMRI_PCA_499d_84p.csv'
...
# 保存为CSV
output_file = 'data/processed/fMRI_ICA_100dim.csv'
...
print(f"  - Columns 2-101: IC1 to IC100 (Names of 100 ICA dimensions)")
